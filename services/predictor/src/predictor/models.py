...
class HuberRegressorWithHyperparameterTuning:
    ...
    def fit(
        ...
        if self.hyperparam_search_trials == 0:
            ...
            logger.info(
                f"Let's find the best hyperparams for the model {self.hyperparam_search_trials} trials."
            )
...
def get_model_candidates(
    ...
    # reset the index of the models dataframe to have a column with the model names
