...
def predict(
    ...
    def predictor_handler(data: pd.DataFrame):
        """
        ...
        # Keep only Insert and Update for recent data, Because we don't want to
        # score Updated for old data coming from our backfill pipeline.
